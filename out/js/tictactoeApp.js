...
System.registerModule("../../js/TicTacToeGame", [], function() {
  "use strict";
  var __moduleName = "../../js/TicTacToeGame";
  var Block = System.get("../../js/Block").Block;
  ...
  var HEIGHT = 3;
  var MAXITER = 300;
  var TicTacToeGameState = function TicTacToeGameState(player) {
    $traceurRuntime.superConstructor($TicTacToeGameState).call(this);
    this.player = player;
    this.winner = null;
  ...
  var $TicTacToeGameState = TicTacToeGameState;
  ($traceurRuntime.createClass)(TicTacToeGameState, {
    get: function(x, y) {
  ...
  var TicTacToeGame = function TicTacToeGame(blockSize) {
    var that = this;
    this.gameOver = $('#gameover').hide().on('touchstart mousedown', function() {
      that.reset();
    });
    this.gameOverText = $('#gameover-text');
    $traceurRuntime.superConstructor($TicTacToeGame).call(this, WIDTH, HEIGHT, blockSize);
    this.winsRed = 0;
    this.winsBlue = 0;
    this.reset();
  };
  var $TicTacToeGame = TicTacToeGame;
  ($traceurRuntime.createClass)(TicTacToeGame, {
    click: function(e) {
    ...
    reset: function() {
      $traceurRuntime.superGet(this, $TicTacToeGame.prototype, "reset").call(this);
  ...
  return {get TicTacToeGame() {
      return TicTacToeGame;
    }};
});
System.registerModule("../../js/tictactoeApp.js", [], function() {
  "use strict";
  var __moduleName = "../../js/tictactoeApp.js";
  var TicTacToeGame = System.get("../../js/TicTacToeGame").TicTacToeGame;
  var blockSize;
  var game;
  function adjustSize() {
    var portrait = window.innerWidth < window.innerHeight;
    var nx = window.innerWidth / 6;
    var ny = window.innerHeight / 5;
    var n = (portrait) ? ny : nx;
